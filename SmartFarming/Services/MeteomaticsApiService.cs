...
namespace SmartFarming.Services
{
    ...
    public class MeteomaticsApiService
    {
        ...
        public async Task<string> GetWeatherDataAsync()
        {
            ...
            string endpoint = $"https://api.meteomatics.com/2024-10-05T00:00:00ZP5D:PT1H/volumetric_soil_water_-5cm:m3m3,volumetric_soil_water_-15cm:m3m3,volumetric_soil_water_-50cm:m3m3,volumetric_soil_water_-150cm:m3m3/47.412164,9.340652/html?source=mix";
